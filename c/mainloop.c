...
static void (*tm_words)(void) = tm1_words;
static int (*tm_info)(int) = tm1_info;

static int opt_auto_space = 0;
...
void main_menu()
{
	...
	static const MenuEntry m[] = {
		...
		M_BUTTON("Training mode 2: flashcard algorithm", M_TM2),
		M_TOGGLE("Auto space", &opt_auto_space),
